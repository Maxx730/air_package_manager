...
onready var _customize = get_node("/root/world/ui/customize")
...
onready var _trip_time = get_node("/root/world/ui/current/trip_time")
onready var _transit = get_node("/root/world/ui/current/transit")
onready var _from_name = get_node("/root/world/ui/current/transit/from_name")
onready var _to_name = get_node("/root/world/ui/current/transit/to_name")
